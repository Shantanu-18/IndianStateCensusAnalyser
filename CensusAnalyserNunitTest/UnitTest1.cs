...
namespace CensusAnalyserNunitTest
{
    public class Tests
    {
        ...
        static string indianStateCensusFilePath = @"E:\FellowShip\IndianStateCensusAnalyser\CensusAnalyserNunitTest\CSVFiles\IndiaStateCensusData.csv";
        static string delimiterIndianCensusFilePath = @"E:\FellowShip\IndianStateCensusAnalyser\CensusAnalyserNunitTest\CSVFiles\DelimiterIndiaStateCensusData.csv";
        static string wrongIndianStateCensusFileType = @"E:\FellowShip\IndianStateCensusAnalyser\CensusAnalyserNunitTest\CSVFiles\IndiaStateCensusData.txt";
        static string wrongIndianStateCensusFilePath = @"E:\FellowShip\IndianStateCensusAnalyser\CensusAnalyserNunitTest\CSVFile\WrongIndiaStateCensusData.csv";
        static string wrongHeaderIndianCensusFilePath = @"E:\FellowShip\IndianStateCensusAnalyser\CensusAnalyserNunitTest\CSVFile\WrongIndiaStateCensusData.csv";
        #endregion UC 1

        #region UC 2 Indian State Code
        static string indianStateCodeHeaders = "SrNo,State Name,TIN,StateCode";
        static string indianStateCodeFilePath = @"E:\FellowShip\IndianStateCensusAnalyser\CensusAnalyserNunitTest\CSVFiles\IndiaStateCode.csv";
        static string delimiterIndianStateCodeFilePath = @"E:\FellowShip\IndianStateCensusAnalyser\CensusAnalyserNunitTest\CSVFiles\DelimiterIndiaStateCode.csv";
        static string wrongIndianStateCodeFileType = @"E:\FellowShip\IndianStateCensusAnalyser\CensusAnalyserNunitTest\CSVFiles\IndiaStateCode.txt";
        static string wrongHeaderStateCodeFilePath = @"E:\FellowShip\IndianStateCensusAnalyser\CensusAnalyserNunitTest\CSVFile\WrongIndiaStateCode.csv";
        #endregion UC 2
